...
# Config
#B unsafe_harm = read_unsafe_file("./sex.txt")
input_file = "./input_blood.csv"
unsafe_harm = pd.read_csv(input_file, header=None).loc[:,0].to_list()
...
print(pred_labels)
print(f"The ASR is {sum(pred_labels)}")